...
public class ImageUtils {
     ...
     * @return
     */
	public static Bitmap decodeSampledBitmapFromMemory(String path, int reqWidth, int reqHeight) {
	...
	/**
	 * Calcola di quanto l'immagine pu� essere ridotta per adattarsi alle dimensioni specificate
	 * @param options
	 * @param reqWidth
	 * @param reqHeight
	 * @return
