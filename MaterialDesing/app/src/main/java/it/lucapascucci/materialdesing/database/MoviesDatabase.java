package it.lucapascucci.materialdesing.database;
...
public class MoviesDatabase {
    ...
    public void insertMoviesBoxOffice(ArrayList<Movie> listMovies, boolean clearPrevious) {
        ...
        for (int i = 0; i < listMovies.size(); i++) {
            ...
            statement.bindLong(3, currentMovie.getReleaseDateTheather() == null ? -1 : currentMovie.getReleaseDateTheather().getTime());
            ...
            statement.bindString(9, currentMovie.getUrlReview());
    ...
    public ArrayList<Movie> getAllMoviesBoxOffice() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            do {
                ...
                movie.setReleaseDateTheather  (releaseDateMilliseconds != -1 ? new Date(releaseDateMilliseconds) : null);
                ...
                movie.setUrlReview(cursor.getString(cursor.getColumnIndex(MoviesHelper.COLUMN_URL_REVIEWS)));
